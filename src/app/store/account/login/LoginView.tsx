...
export default function LoginView({ lang }: { lang: Language }) {
  ...
  return (
    <div className="max-w-sm mx-auto card space-y-3">
      ...
      <p className="text-xs text-gray-500 text-center">
        {t.noAccount} <Link href="/store/account/register" className="text-brand hover:underline">{t.registerLink}</Link>
      </p>
    </div>
  );
}
